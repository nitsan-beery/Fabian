...
files_dir = "./data files"#/IM 0113-08-set2"
...
corners_on_inp_net = 'corners_inp_net'
corners_on_net_line = 'corners_on_net_line'
corners_on_both = 'corners_on_both'
handle_corners_mode_clear_on_inp_net = 'clear_on_inp_net'
handle_corners_mode_clear_on_net_line = 'clear_on_net_line'
handle_corners_mode_clear_on_both = 'clear_on_both'
...
split_mode_by_percentage_list = 'by_percentage_list'
